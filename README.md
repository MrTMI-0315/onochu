...
1. [`docs/mb-plan.md`](/Users/mrtmi/Desktop/Mr_TMI/repos/onochu/docs/mb-plan.md)의 `MB 22` 기준으로 route별 acceptance criteria QA와 mobile usability 점검
2. 남은 PRD v0.3 갭을 route별 체크리스트로 정리
